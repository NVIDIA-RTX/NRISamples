...
bool Sample::Initialize(nri::GraphicsAPI graphicsAPI, bool) {
    ...
    const uint64_t vertexDataSize = sizeof(g_VertexData);
    {
        ...
        { // Layered target for multiview
            ...
            textureDesc.width = (nri::Dim_t)GetOutputResolution().x / 2u;
    ...
    {     // Descriptors
        ...
        { // Multiview attachment
            nri::TextureViewDesc textureViewDesc = {m_MultiviewTexture, nri::TextureView::COLOR_ATTACHMENT, swapChainFormat, 0, 1, 0, VIEW_NUM};
            NRI_ABORT_ON_FAILURE(NRI.CreateTextureView(textureViewDesc, m_MultiviewAttachment));
        }
...
void Sample::RenderFrame(uint32_t frameIndex) {
    ...
    NRI.BeginCommandBuffer(*commandBuffer, m_DescriptorPool);
    {
        ...
        { // Copy
            ...
            NRI.CmdCopyTexture(*commandBuffer, *swapChainTexture.texture, &dstRegionDesc, *m_MultiviewTexture, &srcRegionDesc);
